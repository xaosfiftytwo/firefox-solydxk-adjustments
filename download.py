...
extensions.append(['ublock', 'https://addons.mozilla.org/firefox/downloads/latest/607454/', False])

# Set profile dir
script_dir = dirname(realpath(__file__))
profile_dir = join(script_dir, "etc/skel/.mozilla/firefox/mwad0hks.default")
